...
public class RepackageApktool {
	...
	private static void recompileApk() {
		...
		outputApkPath = new File(SootEnvironment.outputApkDirectory).getAbsolutePath() + "/" + SootEnvironment.apkFileName.replace(".apk", "_ipa.apk");
