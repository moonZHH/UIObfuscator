...
public class GenResourceFile {
	...
	public static void generate() {
		File assetDirectory = new File(SootEnvironment.decompileDirectoryPath + "/" + "assets");
		boolean includeAssets = assetDirectory.exists();
		...
		if (SootEnvironment.minAPILevel.equals("") && SootEnvironment.tgtAPILevel.equals("")) {
			if (includeAssets) {
				commands.add(String.format("%s %s %s %s %s %s %s %s %s %s %s %s %s", 
						...
						"-A", SootEnvironment.decompileDirectoryPath + "/" + "assets",
